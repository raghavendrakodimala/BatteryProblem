...
namespace AverageDailyBatteryUsage.Main
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IBatteryUsageCalculatorRepository, BatteryUsageCalculatorRepository>();
            services.AddScoped<IBatteryUsageCalculateManager, BatteryUsageCalculateManager>();
        }
